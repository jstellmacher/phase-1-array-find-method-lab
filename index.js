...
function superbowlWin(record) {
  let win = record.find((w) => w.result === "W");
  if (win) {
    return win.year;
  } else {
    return undefined;
...
//how to understand this: parameter is record which is

// function superbowlWin(record) {
//   const winYear = record.find((record) => record.record.result === "W");
//   return winYear ? winYear.year : undefined;
// }

//attempting to use arrow functions^
